...
export default function Sidebar({ isCollapsed, setIsCollapsed }: SidebarProps) {
  return (
    <motion.aside
      className={clsx(
        "fixed top-0 left-0 h-screen z-40 flex flex-col bg-white/90 dark:bg-gray-900/90 backdrop-blur-xl border-r border-gray-200/70 dark:border-gray-800/70 shadow-lg transition-all duration-300",
        isCollapsed ? "w-20 items-center" : "w-80"
      )}
      initial={false}
      animate={{
